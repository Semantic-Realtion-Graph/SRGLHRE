...
if __name__ == '__main__':
    ...
    parser.add_argument("--model_name_or_path", default="./model", help="Path to input model")
    ...
    parser.add_argument("--gcn_layer_num", default=3, type=int, help="number layers of GCN")

    parser.add_argument("--model_type", default="bert", type=str, help="Model type selected in the list: " + ", ".join(MODEL_CLASSES.keys()))
    parser.add_argument("--entity_start", action='store_true', help="Entity start,if False,use entity average")
    ...
    parser.add_argument("--graph_file", default="graph.json", type=str, help="Graph file")
